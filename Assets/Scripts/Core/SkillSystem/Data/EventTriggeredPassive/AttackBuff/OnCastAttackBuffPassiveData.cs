...
/// <c>PassiveSkillData</c>를 상속받으며, <c>IRuntimePassiveEffectFactory</c>를 구현합니다.
/// </summary>
/// <remarks>
...
public class OnCastAttackBuffPassiveData : PassiveSkillData, IRuntimePassiveEffectFactory
{
    ...
    /// <c>OnCastAttackBuffEffect</c> 인스턴스를 생성하여 반환하며, 공격력 버프 데이터를 전달합니다.
    /// </summary>
    /// <returns>생성된 <c>OnCastAttackBuffEffect</c> 인스턴스입니다. <c>attackBuffData</c>가 할당되지 않은 경우 <c>null</c>을 반환합니다.</returns>
