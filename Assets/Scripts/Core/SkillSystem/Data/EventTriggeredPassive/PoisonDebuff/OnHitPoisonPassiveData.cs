...
public class OnHitPoisonPassiveData : PassiveSkillData, IRuntimePassiveEffectFactory
{
    ...
    /// <c>OnHitPoisonEffect</c> 인스턴스를 생성하여 반환하며, 독 효과 데이터를 전달합니다.
    /// </summary>
    /// <returns>생성된 <c>OnHitPoisonEffect</c> 인스턴스입니다. <c>poisonEffectData</c>가 할당되지 않은 경우 <c>null</c>을 반환합니다.</returns>
