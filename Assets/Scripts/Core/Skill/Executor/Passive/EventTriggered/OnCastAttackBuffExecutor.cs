...
/// </summary>
public class OnCastAttackBuffExecutor : IPassiveSkillExecutor
{
    ...
    /// </summary>
    public void OnSkillHit(Character caster, Character target, RuntimeSkill skillInstance, float damageDealt)
    {
