...
public interface IPassiveSkillExecutor
{
    ...
    void OnSkillCast(Character caster, RuntimeSkill skillInstance);
    ...
    void OnSkillHit(Character caster, Character target, RuntimeSkill skillInstance, float damageDealt);
}