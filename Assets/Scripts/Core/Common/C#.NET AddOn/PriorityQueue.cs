...
namespace System.Collections.Generic
{
    ...
    public class PriorityQueue<TElement, TPriority>
    {
        ...
        public PriorityQueue(int initialCapacity, IComparer<TPriority>? comparer)
        {
            ...
            {
                new ArgumentOutOfRangeException(null, initialCapacity, "(initialCapacity) must be a non-negative value.");
            }
        ...
        public int EnsureCapacity(int capacity)
        {
            if(capacity < 0)
            {
                new ArgumentOutOfRangeException(null, capacity, "(capacity) must be a non-negative value.");
            }
